...
fun ProfileScreen(postsVm: PostsViewModel, themeVm: ThemeViewModel) {
    ...
    Column(
        ...
        Text("Johnden M. Llatuna", style = MaterialTheme.typography.headlineSmall)
        Text("jllatuna30115@liceo.edu.ph", style = MaterialTheme.typography.bodyMedium)
        Text("BSIT3-1 · Liceo de Cagayan University",
